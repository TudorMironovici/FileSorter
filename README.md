...
That being said, it's also computationally taxing. It's recommended that you don't enable this setting if you're going through:
- a lot of files
- have slower hardware (don't have CUDA cores)
- and/or don't have a lot of time to let the computer processes the data.\
Please make sure you visit https://pytorch.org/ before using this feature. It will tell tell you which versions of pytorch to install for your system's specifications. Otherwise, it will default to using your CPU (may result is extremely slow processing times).
**You can toggle on/off the ability to automatically add all sub-folders when you add a folder to sort through on the "Sort folders" tab**
...
And an interactable row that looks somewhat like this:
